...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Cambia {id} por {olimpista}
    Route::get('/olimpistas/{olimpista}', [Gestion_Olimpista_Controller::class, 'show']);
    Route::put('/olimpistas/{olimpista}', [Gestion_Olimpista_Controller::class, 'update']);
    Route::delete('/olimpistas/{olimpista}', [Gestion_Olimpista_Controller::class, 'destroy']);
    // Es buena práctica que la importación también esté protegida
    ...
    Route::middleware('is_admin')->group(function () {
        ...
        // Route::delete('/admin/users/{id}', [UserController::class, 'destroy']); // Para eliminar un usuario
    });
