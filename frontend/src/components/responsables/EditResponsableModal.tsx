...
export function EditResponsableModal({ 
    ...
    const validate = () => {
        ...
        if (editedResponsable.telefono && editedResponsable.telefono.length !== 8) newErrors.telefono = "El teléfono debe tener exactamente 8 dígitos.";
    ...
    const validateField = (name: string, value: string) => {
        ...
        switch (name) {
            ...
            case "email":
                ...
                break;
            case "telefono":
                if (value && value.length !== 8) newErrors.telefono = "El teléfono debe tener exactamente 8 dígitos.";
